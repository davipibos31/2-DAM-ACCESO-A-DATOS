...
public class Principal {
	...
	public void principal() {
		...
		try {
			...
			if (conn1 != null) {
				System.out.println("conectado a practica 3");
	...
	public String pedirTabla() {
		System.out.println("Las tablas son clientes, empleados, proyectos, asig_proyectos: ");
	...
	public void menu() {
		...
		try {
			...
			do {
				...
				if (sig) {
					if (rs.next() != false) {
						//System.out.println("fila" + " " + rs.getRow() + " " + "Dni: " + rs.getString("DNI")
							//	+ " apellidos: " + rs.getString("APELLIDOS") + " cp: " + rs.getString("CP"));
				...
				System.out.println("Para avanzar pulse k, para el anterior pulse d y para terminar pulse .");
